    ...
    <div className="bg-gray-50 p-8 rounded-lg shadow-inner">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-center flex items-center justify-center space-x-4">
          ...
          <a href="https://wa.me/5511995978139" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white font-bold py-3 px-8 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-transform transform hover:scale-105">
            Fale agora
          </a>
        </div>
