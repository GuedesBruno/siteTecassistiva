...
export async function getImersaoBySlug(slug) {
  const populateQuery = 'populate[botoes_personalizados]=*&populate[produto][fields][0]=nome&populate[produto][fields][1]=descricao_curta&populate[produto][populate][0]=imagem_principal&populate[produto][populate][1]=categorias';
