...
export async function getImersaoBySlug(slug) {
  const populateQuery = 'populate[personalizado]=*&populate[produto][fields][0]=nome&populate[produto][fields][1]=descricao_curta&populate[produto][populate][imagem_principal]=*&populate[produto][populate][categorias]=*&fields[0]=genero_descricao';
