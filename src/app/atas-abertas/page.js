      ...
      <section className="my-12">
        ...
        <div className="prose max-w-4xl mx-auto text-gray-700">
            ...
            <div className="text-center mt-8">
                <a href="#contact-form" className="bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300">Queremos te contar mais, clique aqui.</a>
            </div>
        </div>
      </section>
